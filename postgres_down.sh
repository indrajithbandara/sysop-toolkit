...
#
su -l postgres -c "cp /var/lib/pgsql/9.5/data/recovery.conf /tmp/recovery.conf"
su -l postgres -c "mv /var/lib/pgsql/9.5/data/recovery.conf /var/lib/pgsql/9.5/data/recovery.done"
#
